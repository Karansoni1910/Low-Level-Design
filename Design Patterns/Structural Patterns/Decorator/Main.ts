...
const fullPizza: Pizza = new MushroomDecorator(new OliveDecorator(new CheeseDecorator(new PlainPizza())));
console.log(`${fullPizza.getDescription()} | $${fullPizza.getCost().toFixed(2)}`);
